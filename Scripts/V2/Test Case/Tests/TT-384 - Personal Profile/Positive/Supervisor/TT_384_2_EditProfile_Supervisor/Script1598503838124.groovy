...
not_run: WebUI.setText(findTestObject('Object Repository/V2/TT-384/Page_Login/input__username'), GlobalVariable.supervisor_email)
...
WebUI.setText(findTestObject('Object Repository/V2/TT-384/Page_Profile/input__firstName'), 'Supervisor')
