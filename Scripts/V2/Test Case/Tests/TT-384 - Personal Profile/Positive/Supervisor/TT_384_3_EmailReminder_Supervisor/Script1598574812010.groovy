...
WebUI.verifyElementPresent(findTestObject('V2/TT-384/Page_Profile/span_Receive To-Do email reminders_switchIn_ddc8da'), 
    GlobalVariable.DefaultTimeout)

WebUI.click(findTestObject('V2/TT-384/Page_Profile/span_Receive To-Do email reminders_switchIn_ddc8da'))
...
WebUI.click(findTestObject('Object Repository/V2/TT-384/Page_Profile/input_pm_todoReminderTime'))

WebUI.click(findTestObject('Object Repository/V2/TT-384/Page_Profile/div_ampm1200'))

WebUI.click(findTestObject('Object Repository/V2/TT-384/Page_Profile/input_Reminder frequency_todoReminderFrequency'))

WebUI.click(findTestObject('Object Repository/V2/TT-384/Page_Profile/div_Every other day'))
...
WebUI.click(findTestObject('V2/TT-384/Page_Profile/div_Save2'))
