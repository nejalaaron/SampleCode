...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-384 - Personal Profile/Positive/Admin/TT_384_3_EmailReminder_Admin'), 
    [:], FailureHandling.STOP_ON_FAILURE)

DriverFactory.changeWebDriver(driver2)

WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-384 - Personal Profile/Positive/Supervisor/TT_384_3_EmailReminder_Supervisor'), 
    [:], FailureHandling.STOP_ON_FAILURE)

DriverFactory.changeWebDriver(driver3)

WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-384 - Personal Profile/Positive/Employee/TT_384_3_EmailReminder_Employee'), 
    [:], FailureHandling.STOP_ON_FAILURE)
