...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-473 - Quarterly Printouts/Test Cases/Negative/Admin/TT_473_2_GenerateQP_L10Meeting_WithoutCoverPage_Admin'), 
    [('meetingName') : meetingName, ('meetingAcronym') : meetingAcronym, ('meetingType') : meetingType, ('dayOfmeeting') : dayOfmeeting
        , ('meetingTime') : meetingTime, ('meetingOptions_obj') : '//h4[text()=\'%s\']/ancestor::div[contains(@class,\'ListContainer\')]/div[@class=\'listcontainer__options\']/button'], 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-473 - Quarterly Printouts/Test Cases/Negative/Supervisor/TT_473_2_GenerateQP_L10Meeting_WithoutCoverPage_Supervisor'), 
    [('meetingName') : meetingName, ('meetingAcronym') : meetingAcronym, ('meetingType') : meetingType, ('dayOfmeeting') : dayOfmeeting
        , ('meetingTime') : meetingTime, ('meetingOptions_obj') : '//h4[text()=\'%s\']/ancestor::div[contains(@class,\'ListContainer\')]/div[@class=\'listcontainer__options\']/button'], 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-473 - Quarterly Printouts/Test Cases/Negative/Employee/TT_473_2_GenerateQP_L10Meeting_WithoutCoverPage_Employee'), 
    [('meetingName') : meetingName, ('meetingAcronym') : meetingAcronym, ('meetingType') : meetingType, ('dayOfmeeting') : dayOfmeeting
        , ('meetingTime') : meetingTime, ('meetingOptions_obj') : '//h4[text()=\'%s\']/ancestor::div[contains(@class,\'ListContainer\')]/div[@class=\'listcontainer__options\']/button'], 
    FailureHandling.STOP_ON_FAILURE)
