...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-473 - Quarterly Printouts/Test Cases/Positive/Admin/TT_473_1_GenerateQP_L10meeting_Admin'), 
...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-473 - Quarterly Printouts/Test Cases/Positive/Supervisor/TT_473_1_GenerateQP_L10meeting_Supervisor'), 
    [('meetingName') : meetingName, ('meetingAcronym') : meetingAcronym, ('meetingType') : meetingType, ('dayOfmeeting') : dayOfmeeting
        , ('meetingTime') : meetingTime, ('meetingOptions_obj') : '//h4[text()=\'%s\']/ancestor::div[contains(@class,\'ListContainer\')]/div[@class=\'listcontainer__options\']/button'], 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-473 - Quarterly Printouts/Test Cases/Positive/Employee/TT_473_1_GenerateQP_L10meeting_Employee'), 
    [('meetingName') : meetingName, ('meetingAcronym') : meetingAcronym, ('meetingType') : meetingType, ('dayOfmeeting') : dayOfmeeting
        , ('meetingTime') : meetingTime, ('meetingOptions_obj') : '//h4[text()=\'%s\']/ancestor::div[contains(@class,\'ListContainer\')]/div[@class=\'listcontainer__options\']/button'], 
    FailureHandling.STOP_ON_FAILURE)
