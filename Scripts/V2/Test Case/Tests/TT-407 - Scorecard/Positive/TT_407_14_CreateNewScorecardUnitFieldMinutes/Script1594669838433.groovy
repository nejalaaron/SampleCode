...
WebUI.click(findTestObject('V2/TT-407/Page_Dashboard/Selected_Unit_Field_Minutes'))
...
WebUI.click(findTestObject('V2/TT-407/Page_Dashboard/Selected_Whosaccountable'))
