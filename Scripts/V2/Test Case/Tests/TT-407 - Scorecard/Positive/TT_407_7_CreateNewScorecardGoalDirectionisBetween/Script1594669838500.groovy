...
WebUI.click(findTestObject('V2/TT-407/Page_Dashboard/Goal_Direction_Number_Between'))

WebUI.setText(findTestObject('V2/TT-407/Page_Dashboard/Low_End_Field'), lowEnd)

WebUI.setText(findTestObject('V2/TT-407/Page_Dashboard/High_End_Field'), highEnd)
...
WebUI.click(findTestObject('V2/TT-407/Page_Dashboard/Selected_Unit_Field_Dollar'))
