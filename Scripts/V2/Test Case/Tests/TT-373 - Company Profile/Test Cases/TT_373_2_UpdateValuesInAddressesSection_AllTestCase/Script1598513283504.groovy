...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-373 - Company Profile/Test Cases/Positive/Admin/TT_373_2_UpdateValuesInAddressesSection_Admin'), 
    [('username') : '', ('password') : '', ('rnd_stringLength') : rnd_stringLength, ('address') : address, ('building') : building
        , ('city') : city, ('zipCode') : zipCode, ('country') : country, ('state') : state], FailureHandling.STOP_ON_FAILURE)

DriverFactory.changeWebDriver(driver2)

WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-373 - Company Profile/Test Cases/Positive/Supervisor/TT_373_2_UpdateValuesInAddressesSection_Supervisor'), 
    [('username') : '', ('password') : '', ('rnd_stringLength') : rnd_stringLength, ('address') : address, ('building') : building
        , ('city') : city, ('zipCode') : zipCode, ('country') : country, ('state') : state], FailureHandling.STOP_ON_FAILURE)

DriverFactory.changeWebDriver(driver3)

WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-373 - Company Profile/Test Cases/Positive/Employee/TT_373_2_UpdateValuesInAddressesSection_Employee'), 
    [('username') : '', ('password') : '', ('rnd_stringLength') : rnd_stringLength, ('address') : address, ('building') : building
        , ('city') : city, ('zipCode') : zipCode, ('country') : country, ('state') : state], FailureHandling.STOP_ON_FAILURE)
