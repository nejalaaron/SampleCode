...
WebUI.waitForElementVisible(findTestObject('V2/PR-369/UpdateEditMeetingScorecard/Edit_Measurable_Title_Field'), GlobalVariable.DefaultTimeout)
...
WebUI.waitForElementVisible(findTestObject('V2/PR-369/UpdateEditMeetingScorecard/Edit_Goal_Type_Field'), GlobalVariable.DefaultTimeout)

WebUI.click(findTestObject('V2/PR-369/UpdateEditMeetingScorecard/Edit_Goal_Type_Field'))

WebUI.waitForElementVisible(findTestObject('V2/PR-369/UpdateEditMeetingScorecard/Edit_Goal_Type_Number'), GlobalVariable.DefaultTimeout)

WebUI.click(findTestObject('V2/PR-369/UpdateEditMeetingScorecard/Edit_Goal_Type_Number'))

WebUI.waitForElementVisible(findTestObject('V2/PR-369/UpdateEditMeetingScorecard/Edit_Unit_Field'), GlobalVariable.DefaultTimeout)
...
WebUI.waitForElementVisible(editUnit, GlobalVariable.DefaultTimeout)

WebUI.click(editUnit)

WebUI.waitForElementVisible(findTestObject('V2/PR-369/UpdateEditMeetingScorecard/Edit_Goal'), GlobalVariable.DefaultTimeout)
...
WebUI.waitForElementVisible(findTestObject('V2/PR-369/UpdateEditMeetingScorecard/Edit_Goal_Description'), GlobalVariable.DefaultTimeout)

WebUI.setText(findTestObject('V2/PR-369/UpdateEditMeetingScorecard/Edit_Goal_Description'), editGoalDescription)

WebUI.waitForElementVisible(findTestObject('V2/PR-369/UpdateEditMeetingScorecard/Edit_Accountable'), GlobalVariable.DefaultTimeout)
...
WebUI.waitForElementVisible(editAccountable, GlobalVariable.DefaultTimeout)

WebUI.click(editAccountable)

WebUI.waitForElementVisible(findTestObject('V2/PR-369/UpdateEditMeetingScorecard/Edit_Admin_Access'), GlobalVariable.DefaultTimeout)
...
WebUI.waitForElementVisible(editAdminAccess, GlobalVariable.DefaultTimeout)

WebUI.click(editAdminAccess)

WebUI.waitForElementVisible(findTestObject('V2/PR-369/UpdateEditMeetingScorecard/Edit_Show_Advanced_Fields_Button'), GlobalVariable.DefaultTimeout)

WebUI.click(findTestObject('V2/PR-369/UpdateEditMeetingScorecard/Edit_Show_Advanced_Fields_Button'))

WebUI.waitForElementVisible(findTestObject('V2/PR-369/UpdateEditMeetingScorecard/Edit_Average_DateField'), GlobalVariable.DefaultTimeout)
...
WebUI.waitForElementVisible(findTestObject('V2/PR-369/Edit_Meeting_Scorecard/Average_Checkbox'), GlobalVariable.DefaultTimeout)

WebUI.check(findTestObject('V2/PR-369/Edit_Meeting_Scorecard/Average_Checkbox'))

WebUI.waitForElementVisible(findTestObject('V2/PR-369/UpdateEditMeetingScorecard/Edit_Cumulative_DateField'), GlobalVariable.DefaultTimeout)
...
WebUI.waitForElementVisible(findTestObject('V2/PR-369/Edit_Meeting_Scorecard/Cumulative_Checkbox'), GlobalVariable.DefaultTimeout)

WebUI.check(findTestObject('V2/PR-369/Edit_Meeting_Scorecard/Cumulative_Checkbox'))

WebUI.waitForElementVisible(findTestObject('V2/PR-369/UpdateEditMeetingScorecard/Edit_Update_Button'), GlobalVariable.DefaultTimeout)
