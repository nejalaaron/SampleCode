...
WebUI.waitForElementVisible(verifyToDo, GlobalVariable.DefaultTimeout)
...
WebUI.waitForElementVisible(findTestObject('V2/PR-369/UpdateEditMeetingToDo/Edit_Accountable_Owner'), GlobalVariable.DefaultTimeout)
...
WebUI.waitForElementVisible(editaccountableOwner, GlobalVariable.DefaultTimeout)

WebUI.click(editaccountableOwner)

WebUI.waitForElementVisible(findTestObject('V2/PR-369/UpdateEditMeetingToDo/Edit_Due_Date'), GlobalVariable.DefaultTimeout)
...
WebUI.waitForElementVisible(findTestObject('V2/PR-369/UpdateEditMeetingToDo/Edit_Done_Checkbox'), GlobalVariable.DefaultTimeout)

WebUI.click(findTestObject('V2/PR-369/UpdateEditMeetingToDo/Edit_Done_Checkbox'))

WebUI.waitForElementVisible(findTestObject('V2/PR-369/UpdateEditMeetingToDo/Update_Button'), GlobalVariable.DefaultTimeout)
