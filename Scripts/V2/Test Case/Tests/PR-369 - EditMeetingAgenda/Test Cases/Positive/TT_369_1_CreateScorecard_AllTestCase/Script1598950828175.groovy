...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/PR-369 - EditMeetingAgenda/Test Cases/Positive/Admin/PR_369_6_EditMeetingCreateScorecard_Admin'), 
...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/PR-369 - EditMeetingAgenda/Test Cases/Positive/Supervisor/PR_369_6_EditMeetingCreateScorecard_Supervisor'), 
    [('userName') : 'jeff+075@mytractiontools.com', ('passWord') : 'Skyline69A*', ('meetingRowPosition') : '3', ('editMeetingMenu_Obj') : '//div[@id=\'root\']/div/div[2]/div/div/div/div[2]/div/div[%s]/div[3]/button/i'
        , ('measurableTitle') : 'QA Automation Edit Meeting Scorecard', ('goalValue') : 'YES', ('WhosAccountable_Obj') : '//div[contains(@id,\'editMeetingCreateScorecard\')]/div[@data-test-id=\'createMeasurable\']//div[@role=\'listbox\'][@class=\'visible menu transition\']/div[contains(@class,\'item\')]/span[text()=\'%s\']'
        ...
        , ('editUnit_Obj') : '//div[contains(@id,\'EDIT_MEASURABLE\')]//div[@role=\'listbox\'][@class=\'visible menu transition\']/div/span[text()=\'%s\']'
        , ('editUnit') : 'Dollars ($)', ('editGoal') : '1', ('editGoalDescription') : 'USD', ('editAccountable_Obj') : '//div[contains(@id,\'EDIT_MEASURABLE\')]//div[@role=\'listbox\'][@class=\'visible menu transition\']/div[contains(@class,\'item\')]/span[text()=\'%s\']'
        , ('editAccountable') : 'Supervisor User', ('editAdminAccess_Obj') : '//div[contains(@id,\'EDIT_MEASURABLE\')]//div[@class=\'visible menu transition\']/div[contains(@class,\'item\')]/span[text()=\'%s\']'
        , ('editAdminAccess') : 'Supervisor User', ('editAverage_Obj') : '(//*[normalize-space(text()) and normalize-space(.)=\'June 2020\'])[1]/following::div[%s]'
        , ('editCumulative_Obj') : '(//*[normalize-space(text()) and normalize-space(.)=\'June 2020\'])[1]/following::div[%s]'
        , ('editAverage') : '30', ('editCumulative') : '30', ('editColumn2') : '200', ('editColumn3') : '200', ('editColumn4') : '10'
        , ('editColumn5') : '30', ('editColumn6') : '500', ('editColumn7') : '200', ('meetingOptions_obj') : '//h4[text()=\'%s\']/ancestor::div[contains(@class,\'ListContainer\')]/div[@class=\'listcontainer__options\']/button'
...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/PR-369 - EditMeetingAgenda/Test Cases/Positive/Employee/PR_369_6_EditMeetingCreateScorecard_Employee'), 
    [('userName') : 'jeff+075@mytractiontools.com', ('passWord') : 'Skyline69A*', ('meetingRowPosition') : '3', ('editMeetingMenu_Obj') : '//div[@id=\'root\']/div/div[2]/div/div/div/div[2]/div/div[%s]/div[3]/button/i'
        ...
        , ('editUnit_Obj') : '//div[contains(@id,\'EDIT_MEASURABLE\')]//div[@role=\'listbox\'][@class=\'visible menu transition\']/div/span[text()=\'%s\']'
        , ('editUnit') : 'Dollars ($)', ('editGoal') : '1', ('editGoalDescription') : 'USD', ('editAccountable_Obj') : '//div[contains(@id,\'EDIT_MEASURABLE\')]//div[@role=\'listbox\'][@class=\'visible menu transition\']/div[contains(@class,\'item\')]/span[text()=\'%s\']'
        , ('editAccountable') : 'Employee User', ('editAdminAccess_Obj') : '//div[contains(@id,\'EDIT_MEASURABLE\')]//div[@class=\'visible menu transition\']/div[contains(@class,\'item\')]/span[text()=\'%s\']'
        , ('editAdminAccess') : 'Employee User', ('editAverage_Obj') : '(//*[normalize-space(text()) and normalize-space(.)=\'June 2020\'])[1]/following::div[%s]'
        , ('editCumulative_Obj') : '(//*[normalize-space(text()) and normalize-space(.)=\'June 2020\'])[1]/following::div[%s]'
        , ('editAverage') : '30', ('editCumulative') : '30', ('editColumn2') : '200', ('editColumn3') : '200', ('editColumn4') : '10'
        , ('editColumn5') : '30', ('editColumn6') : '500', ('editColumn7') : '200', ('meetingOptions_obj') : '//h4[text()=\'%s\']/ancestor::div[contains(@class,\'ListContainer\')]/div[@class=\'listcontainer__options\']/button'
