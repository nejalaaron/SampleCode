...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-408 - ToDo/Admin/TT_408_2_CreateNewToDoWithDoneStatus_Admin'), [('userName') : ''
        ...
        , ('accountableOwner') : accountableOwner, ('meetingName') : meetingName, ('assignedMeeting_Obj') : '//div[@id=\'CREATE_TODO\']//div[@role=\'listbox\'][@class=\'visible menu transition\']/div/span[text()=\'%s\']'
        , ('accountableOwner_Obj') : '//div[contains(@id,\'CREATE_TODO\')]//span[text()=\'%s\']/parent::div', ('date_Obj') : '(//*[normalize-space(text()) and normalize-space(.)=\'September 2020\'])[1]/following::div[%s]'
        , ('todoDone') : '//div[@data-test-id=\'todos\']//div[@class=\'tooltip_Listener\']/i[contains(@class,\'icon-checkbox-filled\')]'], 
    FailureHandling.STOP_ON_FAILURE)

DriverFactory.changeWebDriver(driver2)

WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-408 - ToDo/Supervisor/TT_408_2_CreateNewToDoWithDoneStatus_Supervisor'), 
    [('userName') : '', ('passWord') : '', ('todoName') : todoName, ('day') : day, ('todoVerify_Obj') : '//h2[text()=\'To-Dos\']/ancestor::div[contains(@class,\'CardStyles\')]/div[2]//div[contains(@class,\'TextBodyStyles\') and text()=\'%s\']'
        , ('accountableOwner2') : accountableOwner2, ('meetingName') : meetingName, ('assignedMeeting_Obj') : '//div[@id=\'CREATE_TODO\']//div[@role=\'listbox\'][@class=\'visible menu transition\']/div/span[text()=\'%s\']'
        , ('accountableOwner_Obj') : '//div[contains(@id,\'CREATE_TODO\')]//span[text()=\'%s\']/parent::div', ('todoDone') : '//div[text()=\'%s\']/ancestor::div[contains(@class,\'ItemStyles\')]//input[@type=\'checkbox\']'
        , ('date_Obj') : '(//*[normalize-space(text()) and normalize-space(.)=\'September 2020\'])[1]/following::div[%s]'], 
    FailureHandling.STOP_ON_FAILURE)

DriverFactory.changeWebDriver(driver3)

WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-408 - ToDo/Employee/TT_408_2_CreateNewToDoWithDoneStatus_Employee'), 
    [('userName') : '', ('passWord') : '', ('todoName') : todoName, ('day') : day, ('todoVerify_Obj') : '//h2[text()=\'To-Dos\']/ancestor::div[contains(@class,\'CardStyles\')]/div[2]//div[contains(@class,\'TextBodyStyles\') and text()=\'%s\']'
        , ('accountableOwner3') : accountableOwner3, ('meetingName') : meetingName, ('assignedMeeting_Obj') : '//div[@id=\'CREATE_TODO\']//div[@role=\'listbox\'][@class=\'visible menu transition\']/div/span[text()=\'%s\']'
        , ('accountableOwner_Obj') : '//div[contains(@id,\'CREATE_TODO\')]//span[text()=\'%s\']/parent::div', ('todoDone') : '//div[text()=\'%s\']/ancestor::div[contains(@class,\'ItemStyles\')]//input[@type=\'checkbox\']'
        , ('date_Obj') : '(//*[normalize-space(text()) and normalize-space(.)=\'September 2020\'])[1]/following::div[%s]'], 
    FailureHandling.STOP_ON_FAILURE)
