...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-408 - ToDo/Admin/TT_408_1_CreateNewToDo_Admin'), [('userName') : ''
...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-408 - ToDo/Supervisor/TT_408_1_CreateNewToDo_Supervisor'), [('userName') : ''
        , ('passWord') : '', ('todoName') : todoName, ('day') : day, ('todoVerify_Obj') : '//h2[text()=\'To-Dos\']/ancestor::div[contains(@class,\'CardStyles\')]/div[2]//div[contains(@class,\'TextBodyStyles\') and text()=\'%s\']'
...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-408 - ToDo/Employee/TT_408_1_CreateNewToDo_Employee'), [('userName') : ''
        , ('passWord') : '', ('todoName') : todoName, ('day') : day, ('todoVerify_Obj') : '//h2[text()=\'To-Dos\']/ancestor::div[contains(@class,\'CardStyles\')]/div[2]//div[contains(@class,\'TextBodyStyles\') and text()=\'%s\']'
