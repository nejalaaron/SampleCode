...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-408 - ToDo/Admin/TT_408_3_CancelToDoCreation_Admin'), [('userName') : ''
...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-408 - ToDo/Supervisor/TT_408_3_CancelToDoCreation_Supervisor'), [
...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-408 - ToDo/Employee/TT_408_3_CancelToDoCreation_Employee'), [('userName') : ''
        , ('passWord') : '', ('todoName') : todoName, ('day') : day, ('todoVerify_Obj') : '//h2[text()=\'To-Dos\']/ancestor::div[contains(@class,\'CardStyles\')]/div[2]//div[contains(@class,\'TextBodyStyles\') and text()=\'%s\']'
        , ('meetingName') : meetingName, ('assignedMeeting_Obj') : '//div[@id=\'CREATE_TODO\']//div[@role=\'listbox\'][@class=\'visible menu transition\']/div/span[text()=\'%s\']'
        , ('date_Obj') : '(//*[normalize-space(text()) and normalize-space(.)=\'September 2020\'])[1]/following::div[%s]'], 
    FailureHandling.STOP_ON_FAILURE)
