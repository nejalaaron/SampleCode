...
WebUI.click(findTestObject('V2/TT-408/Page_Dashboard/Done_Status_Checkbox'))
...
TestObject todoDoneObj = CustomKeywords.'tt_CustomKeywords.CustomKeywords.CreateDynamicElement'(todoDone, todoName, 'xpath')

WebUI.verifyElementPresent(todoDoneObj, GlobalVariable.DefaultTimeout)
