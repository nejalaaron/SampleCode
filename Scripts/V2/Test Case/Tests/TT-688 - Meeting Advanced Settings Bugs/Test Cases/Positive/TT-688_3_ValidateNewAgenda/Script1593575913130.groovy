...
WebUI.click(findTestObject('V2/TT-688/Page_Meeting Settings/AddNewSectionButton'))

WebUI.setText(findTestObject('V2/TT-688/Page_Meeting Settings/SectionTitle'), 'Segue')

WebUI.click(findTestObject('V2/TT-688/Page_Meeting Settings/TypeOfSection'))

WebUI.click(findTestObject('V2/TT-688/Page_Meeting Settings/SegueTypeOfSection'))

WebUI.click(findTestObject('V2/TT-688/Page_Meeting Settings/SectionSaveButton'))

WebUI.delay(10)

WebUI.verifyElementPresent(findTestObject('V2/TT-688/Page_Meeting Settings/NewAgenda'), 30)
