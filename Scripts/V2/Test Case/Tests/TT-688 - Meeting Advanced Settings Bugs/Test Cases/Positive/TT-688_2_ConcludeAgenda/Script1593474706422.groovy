...
WebUI.click(findTestObject('V2/TT-688/Page_Meeting Settings/Conclude'))

WebUI.click(findTestObject('V2/TT-688/Page_Meeting Settings/DeleteSectionButtonDisabled'))

WebUI.click(findTestObject('V2/TT-688/Page_Meeting Settings/EditSectionCloseButton'))

WebUI.verifyElementPresent(findTestObject('V2/TT-688/Page_Meeting Settings/Conclude'), GlobalVariable.DefaultTimeout)
