...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-411 - Run Meeting/Test Cases/Positive/Employee/TT_411_7_VerifyConcludeMeetingSection_Employee'), 
    [('permission') : permission_admin], FailureHandling.STOP_ON_FAILURE)

DriverFactory.changeWebDriver(driver2)

WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-411 - Run Meeting/Test Cases/Positive/Supervisor/TT_411_7_VerifyConcludeMeetingSection_Supervisor'), 
    [('permission') : permission_supervisor], FailureHandling.STOP_ON_FAILURE)

DriverFactory.changeWebDriver(driver1)

WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-411 - Run Meeting/Test Cases/Positive/Admin/TT_411_7_VerifyConcludeMeetingSection_Admin'), 
    [('permission') : permission_admin], FailureHandling.STOP_ON_FAILURE)
