...
editPH_title_input_status = WebUI.getAttribute(findTestObject('V2/TT-411/RunMeetingPage/People Headlines/EditPH_title_inputCont'), 
    'disabled')

WebUI.verifyMatch(editPH_title_input_status, 'true', false)

edtPH_owner_dropdown_status = WebUI.getAttribute(findTestObject('V2/TT-411/RunMeetingPage/People Headlines/EditPH_owner_dropdownCont'), 
    'disabled')

WebUI.verifyMatch(edtPH_owner_dropdown_status, 'true', false)

edtPH_STTM_dropdown_status = WebUI.getAttribute(findTestObject('V2/TT-411/RunMeetingPage/People Headlines/EditPH_ShareToMeeting_dropdownCont'), 
    'disabled')

WebUI.verifyMatch(edtPH_STTM_dropdown_status, 'true', false)

edtPH_notes_status = WebUI.getAttribute(findTestObject('V2/TT-411/RunMeetingPage/People Headlines/EditPH_notes_divCont'), 
    'disabled')

WebUI.verifyMatch(edtPH_notes_status, 'true', false)
...
editPH_title_input_status_s = WebUI.getAttribute(findTestObject('V2/TT-411/RunMeetingPage/People Headlines/EditPH_title_inputCont'), 
    'disabled')

WebUI.verifyMatch(editPH_title_input_status_s, 'true', false)

edtPH_owner_dropdown_status_s = WebUI.getAttribute(findTestObject('V2/TT-411/RunMeetingPage/People Headlines/EditPH_owner_dropdownCont'), 
    'disabled')

WebUI.verifyMatch(edtPH_owner_dropdown_status_s, 'true', false)

edtPH_STTM_dropdown_status_s = WebUI.getAttribute(findTestObject('V2/TT-411/RunMeetingPage/People Headlines/EditPH_ShareToMeeting_dropdownCont'), 
    'disabled')

WebUI.verifyMatch(edtPH_STTM_dropdown_status_s, 'true', false)

edtPH_notes_status_s = WebUI.getAttribute(findTestObject('V2/TT-411/RunMeetingPage/People Headlines/EditPH_notes_divCont'), 
    'disabled')

WebUI.verifyMatch(edtPH_notes_status_s, 'true', false)
...
edtPH_owner_dropdown_status_e = WebUI.getAttribute(findTestObject('V2/TT-411/RunMeetingPage/People Headlines/EditPH_owner_dropdownCont'), 
    'disabled')

WebUI.verifyMatch(edtPH_owner_dropdown_status_e, 'true', false)
