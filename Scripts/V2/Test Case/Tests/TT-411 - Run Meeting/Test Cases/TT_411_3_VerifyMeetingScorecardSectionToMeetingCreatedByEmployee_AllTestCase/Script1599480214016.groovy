...
WebUI.callTestCase(findTestCase('V2/Test Case/Pre-conditions/PRE_CreateMeetingScorecardViaEditMeetingPage'), [('meetingName') : meetingNameE
        , ('firstname') : employee_fname, ('lastname') : lastname, ('scorecard_title') : scorecard_title, ('scorecard_goalType') : scorecard_goalType
...
WebUI.callTestCase(findTestCase('V2/Test Case/Pre-conditions/PRE_CreateMeetingScorecardViaEditMeetingPage'), [('meetingName') : meetingNameE
        , ('firstname') : admin_fname, ('lastname') : lastname, ('scorecard_title') : scorecard_title_supervisor, ('scorecard_goalType') : scorecard_goalType
        , ('scorecard_goalDirection') : scorecard_goalDirection, ('scorecard_unit') : scorecard_unit, ('scorecard_goal_val') : scorecard_goal_val
...
WebUI.callTestCase(findTestCase('V2/Test Case/Pre-conditions/PRE_CreateMeetingScorecardViaEditMeetingPage'), [('meetingName') : meetingNameE
        , ('firstname') : supervisor_fname, ('lastname') : lastname, ('scorecard_title') : scorecard_title_employee, ('scorecard_goalType') : scorecard_goalType
        , ('scorecard_goalDirection') : scorecard_goalDirection, ('scorecard_unit') : scorecard_unit, ('scorecard_goal_val') : scorecard_goal_val
...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-411 - Run Meeting/Test Cases/Positive/Employee/TT_411_3_VerifyMeetingScorecardSection_Employee'), 
    [('meetingName') : meetingNameE, ('scorecard_title') : scorecard_title, ('scorecard_title_supervisor') : scorecard_title_supervisor
