...
WebUI.callTestCase(findTestCase('V2/Test Case/Pre-conditions/PRE_CreateMeetingScorecardViaEditMeetingPage'), [('meetingName') : meetingNameS
        , ('firstname') : supervisor_fname, ('lastname') : lastname, ('scorecard_title') : scorecard_title, ('scorecard_goalType') : scorecard_goalType
...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-411 - Run Meeting/Test Cases/Positive/Supervisor/TT_411_3_VerifyMeetingScorecardSection_Supervisor'), 
    [('meetingName') : meetingNameS, ('scorecard_title') : scorecard_title, ('scorecard_title_supervisor') : scorecard_title_supervisor
