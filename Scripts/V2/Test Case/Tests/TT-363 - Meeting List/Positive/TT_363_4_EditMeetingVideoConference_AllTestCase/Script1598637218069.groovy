...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-363 - Meeting List/Positive/Admin/TT_363_25_EditMeetingBI_Admin'), 
    [('username') : '', ('password') : '', ('meetingName') : meetingName, ('meetingAcronym') : meetingAcronym, ('meetingDescription') : meetingDescription
        , ('videoConference') : videoConference, ('meetingTitle') : meetingTitle], FailureHandling.STOP_ON_FAILURE)
...
WebUI.clearText(findTestObject('Object Repository/V2/TT-363/Page_Meeting/Edit_Meeting/Edit_Meeting2/Page_Edit Meeting/input_Video conference URL_meetingLink'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Object Repository/V2/TT-363/Page_Meeting/Edit_Meeting/Edit_Meeting2/Page_Edit Meeting/input_Video conference URL_meetingLink'), 
    videoConference)

WebUI.click(findTestObject('V2/TT-363/Page_Meeting/Edit_Meeting/Page_Edit Meeting/div_Save2'))
...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-363 - Meeting List/Positive/Supervisor/TT_363_25_EditMeetingBI_Supervisor'), 
    [('username') : '', ('password') : '', ('meetingNameS') : meetingNameS, ('meetingAcronym') : meetingAcronym, ('meetingDescription') : meetingDescription
        , ('videoConference') : videoConference, ('meetingTitleS') : meetingTitleS], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-363 - Meeting List/Positive/Employee/TT_363_25_EditMeetingBI_Employee'), 
    [('username') : '', ('password') : '', ('meetingNameE') : meetingNameE, ('meetingAcronym') : meetingAcronym, ('meetingDescription') : meetingDescription
        , ('videoConference') : videoConference, ('meetingTitleE') : meetingTitleE], FailureHandling.STOP_ON_FAILURE)
...
TestObject editMeetingRecordObjAdmin = CustomKeywords.'tt_CustomKeywords.CustomKeywords.CreateDynamicElement'('//div[@class="container__col detailscontainer__block"]/h2/div[text()=\'%s\']', 
    meetingTitle, 'xpath')

WebUI.verifyElementPresent(editMeetingRecordObjAdmin, GlobalVariable.DefaultTimeout)

TestObject editMeetingRecordObjSupervisor = CustomKeywords.'tt_CustomKeywords.CustomKeywords.CreateDynamicElement'('//div[@class="container__col detailscontainer__block"]/h2/div[text()=\'%s\']', 
    meetingTitleS, 'xpath')

WebUI.verifyElementPresent(editMeetingRecordObjSupervisor, GlobalVariable.DefaultTimeout)

TestObject editMeetingRecordObjEmployee = CustomKeywords.'tt_CustomKeywords.CustomKeywords.CreateDynamicElement'('//div[@class="container__col detailscontainer__block"]/h2/div[text()=\'%s\']', 
    meetingTitleE, 'xpath')

WebUI.verifyElementPresent(editMeetingRecordObjEmployee, GlobalVariable.DefaultTimeout)
