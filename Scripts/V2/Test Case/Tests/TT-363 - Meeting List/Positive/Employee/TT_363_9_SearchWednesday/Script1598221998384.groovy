...
WebUI.waitForElementClickable(findTestObject('V2/TT-363/Page_Meeting/Page_Meeting/Page_Meeting/div_Wednesday'), 30)

WebUI.click(findTestObject('V2/TT-363/Page_Meeting/Page_Meeting/Page_Meeting/div_Wednesday'))
