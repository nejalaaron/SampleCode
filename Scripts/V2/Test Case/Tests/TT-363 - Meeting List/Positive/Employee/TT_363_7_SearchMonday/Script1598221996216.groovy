...
WebUI.click(findTestObject('Object Repository/V2/TT-363/Page_Meeting/Page_Meeting/Page_Meeting/button_My meetings_BtnIconStyles-k8ghfj-0 gNflgc'))

WebUI.click(findTestObject('Object Repository/V2/TT-363/Page_Meeting/Page_Meeting/Page_Meeting/div_ie MondayMondayTuesdayWednesdayThursday_10cdc7'))

WebUI.delay(5)

WebUI.waitForElementClickable(findTestObject('Object Repository/V2/TT-363/Page_Meeting/Page_Meeting/Page_Meeting/div_Monday'), 
    30)

WebUI.click(findTestObject('Object Repository/V2/TT-363/Page_Meeting/Page_Meeting/Page_Meeting/div_Monday'))
