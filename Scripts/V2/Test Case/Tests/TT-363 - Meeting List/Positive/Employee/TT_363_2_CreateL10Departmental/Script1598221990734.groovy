...
WebUI.setText(findTestObject('V2/TT-363/Page_Login/input__username'), username)

WebUI.setText(findTestObject('V2/TT-363/Page_Login/input__password'), password)
...
WebUI.click(findTestObject('V2/TT-363/Page_Meeting/div_Wednesday'))
