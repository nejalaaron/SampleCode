...
TestObject accountable_OwnerValObj = CustomKeywords.'tt_CustomKeywords.CustomKeywords.CreateDynamicElement'(owner_Obj, ownerSelected, 
    'xpath')
...
/*WebUI.focus(milestoneRecordObj)*/
WebUI.click(rockRecordObj)

WebUI.delay(20)

WebUI.click(findTestObject('V2/TT-394/Edit_Rock/Edit_Rock_Title'))

WebUI.sendKeys(findTestObject('V2/TT-394/Edit_Rock/Edit_Rock_Title'), Keys.chord(Keys.LEFT_CONTROL, 'a', Keys.BACK_SPACE))

WebUI.setText(findTestObject('V2/TT-394/Edit_Rock/Edit_Rock_Title_Name'), editRockName)

WebUI.click(findTestObject('V2/TT-394/Edit_Rock/Edit_Status_Done_Rock'))

WebUI.click(findTestObject('V2/TT-394/Edit_Rock/edit_Accountable_Owner'))
...
WebUI.click(findTestObject('V2/TT-394/Edit_Rock/Edit_Visibility_Level_Field'))

WebUI.click(findTestObject('V2/TT-394/Edit_Rock/Edit_Visibility_Level_Department_Field'))

WebUI.clearText(findTestObject('V2/TT-394/Edit_Rock/Edit_Milestone'))

WebUI.setText(findTestObject('V2/TT-394/Edit_Rock/Edit_Milestone'), editMilestoneName)

WebUI.click(findTestObject('V2/TT-394/Edit_Rock/Update_Rock_Button'))

WebUI.delay(10)

TestObject edit_RockRecordObj = CustomKeywords.'tt_CustomKeywords.CustomKeywords.CreateDynamicElement'(verifyRocks_Obj, 
    editRockName, 'xpath')

WebUI.verifyElementPresent(edit_RockRecordObj, GlobalVariable.DefaultTimeout)
