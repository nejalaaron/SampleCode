...
String A_nameTitle = WebUI.getAttribute(findTestObject('V2/TT-238/VTO_NameTitle'), 'contenteditable')

CustomKeywords.'tt_CustomKeywords.CustomKeywords.VerifyTextContains'(A_nameTitle, 'false')
