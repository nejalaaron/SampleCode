...
WebUI.waitForElementVisible(findTestObject('V2/TT-238/VTO_10YearTarget'), GlobalVariable.DefaultTimeout)
...
WebUI.sendKeys(findTestObject('V2/TT-238/VTO_10YearTarget'), '10-YEAR TARGET™')
...
WebUI.sendKeys(findTestObject('V2/TT-238/VTO_10YearTarget2'), '10-YEAR TARGET™')
