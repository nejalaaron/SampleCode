...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-238 - VTO/Test Cases/Positive/Admin/TT_238_3_AddCoreValues_Admin'), 
...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-238 - VTO/Test Cases/Positive/Supervisor/TT_238_3_AddCoreValues_Supervisor'), 
    [('admin_fname') : '', ('lastname') : '', ('phonenumber') : '9999999999', ('company') : 'Traction Tools', ('password') : ''
        , ('admin_email_prefix') : '', ('admin_email_domain') : '', ('randomTextLength') : '', ('supervisor_fname') : ''
        , ('employee_fname') : '', ('supervisor_email_prefix') : '', ('supervisor_email_domain') : '', ('supervisor_positionTitle') : ''
        , ('employee_email_prefix') : '', ('employee_email_domain') : '', ('employee_positionTitle') : ''], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-238 - VTO/Test Cases/Positive/Employee/TT_238_3_AddCoreValues_Employee'), 
    [('admin_fname') : '', ('lastname') : '', ('phonenumber') : '9999999999', ('company') : 'Traction Tools', ('password') : ''
        , ('admin_email_prefix') : '', ('admin_email_domain') : '', ('randomTextLength') : '', ('supervisor_fname') : ''
        , ('employee_fname') : '', ('supervisor_email_prefix') : '', ('supervisor_email_domain') : '', ('supervisor_positionTitle') : ''
        , ('employee_email_prefix') : '', ('employee_email_domain') : '', ('employee_positionTitle') : ''], FailureHandling.STOP_ON_FAILURE)
