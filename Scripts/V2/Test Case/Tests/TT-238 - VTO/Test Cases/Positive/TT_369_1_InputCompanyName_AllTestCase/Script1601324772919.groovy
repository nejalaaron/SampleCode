...
WebUI.callTestCase(findTestCase('V2/Test Case/Pre-conditions/PRE_AddAllAttendeesToMeetingEmployee'), [('meetingName') : meetingName
        , ('firstname') : employee_fname, ('lastname') : lastname, ('userOptionObj') : '//span[text()=\'%s\']/parent::div[@role=\'option\']'
        , ('permissionDropObj') : '//div[@role=\'alert\' and text()=\'%s\']/ancestor::div[@class=\'editAttendees__item\']//button[contains(@aria-label,\'assign\')]/parent::div'
        , ('permissionDropOptObj_MA') : '//div[@role=\'alert\' and text()=\'%s\']/ancestor::div[@class=\'editAttendees__item\']//span[text()=\'Meeting Admin\']/parent::div'
        , ('permissionDropOptObj_FE') : '//div[@role=\'alert\' and text()=\'%s\']/ancestor::div[@class=\'editAttendees__item\']//span[text()=\'Full editor\']/parent::div'
        , ('permissionDropOptObj_BE') : '//div[@role=\'alert\' and text()=\'%s\']/ancestor::div[@class=\'editAttendees__item\']//span[text()=\'Basic editor\']'
        , ('meetingOptions_obj') : '//h4[text()=\'%s\']/ancestor::div[contains(@class,\'ListContainer\')]/div[@class=\'listcontainer__options\']/button'
        , ('permission') : permissionDropOptObj_BE], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-238 - VTO/Test Cases/Positive/Admin/TT_238_1_InputCompanyName_Admin'), 
    [('meetingName') : '', ('meetingAcronym') : '', ('meetingType') : '', ('dropdownOptions_obj') : '//div[@id=\'CREATE_MEETING_L10\']//span[text()=\'%s\']/parent::div[@role=\'option\']'
        , ('dayOfMeeting') : '', ('meetingTime') : '', ('meetingRecord_obj') : '//div[@class=\'detailscontainer__block item\']/h4[text()=\'%s\']'
        , ('admin_fname') : '', ('lastname') : '', ('phonenumber') : '9999999999', ('company') : 'Traction Tools', ('password') : ''
        , ('admin_email_prefix') : '', ('admin_email_domain') : '', ('randomTextLength') : '', ('supervisor_fname') : ''
        , ('employee_fname') : '', ('supervisor_email_prefix') : '', ('supervisor_email_domain') : '', ('supervisor_positionTitle') : ''
        , ('employee_email_prefix') : '', ('employee_email_domain') : '', ('employee_positionTitle') : ''], FailureHandling.STOP_ON_FAILURE)

DriverFactory.changeWebDriver(driver2)

WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-238 - VTO/Test Cases/Positive/Supervisor/TT_238_1_InputCompanyName_Supervisor'), 
    [('meetingName') : '', ('meetingAcronym') : '', ('meetingType') : '', ('dropdownOptions_obj') : '//div[@id=\'CREATE_MEETING_L10\']//span[text()=\'%s\']/parent::div[@role=\'option\']'
        , ('dayOfMeeting') : '', ('meetingTime') : '', ('meetingRecord_obj') : '//div[@class=\'detailscontainer__block item\']/h4[text()=\'%s\']'
        , ('admin_fname') : '', ('lastname') : '', ('phonenumber') : '9999999999', ('company') : 'Traction Tools', ('password') : ''
        , ('admin_email_prefix') : '', ('admin_email_domain') : '', ('randomTextLength') : '', ('supervisor_fname') : ''
...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-238 - VTO/Test Cases/Positive/Employee/TT_238_1_InputCompanyName_Employee'), 
    [('meetingName') : '', ('meetingAcronym') : '', ('meetingType') : '', ('dropdownOptions_obj') : '//div[@id=\'CREATE_MEETING_L10\']//span[text()=\'%s\']/parent::div[@role=\'option\']'
        , ('dayOfMeeting') : '', ('meetingTime') : '', ('meetingRecord_obj') : '//div[@class=\'detailscontainer__block item\']/h4[text()=\'%s\']'
        , ('admin_fname') : '', ('lastname') : '', ('phonenumber') : '9999999999', ('company') : 'Traction Tools', ('password') : ''
        , ('admin_email_prefix') : '', ('admin_email_domain') : '', ('randomTextLength') : '', ('supervisor_fname') : ''
