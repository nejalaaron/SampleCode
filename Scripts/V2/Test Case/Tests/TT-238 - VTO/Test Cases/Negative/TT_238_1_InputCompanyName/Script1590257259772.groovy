...
WebUI.sendKeys(findTestObject('V2/TT-238/VTO_NameTitle'), Keys.chord(Keys.LEFT_CONTROL, 'a', Keys.BACK_SPACE))

WebUI.sendKeys(findTestObject('V2/TT-238/VTO_NameTitle'), '`~!@#$%^&*()-=_+[]{};:\'",<.>/?|')
