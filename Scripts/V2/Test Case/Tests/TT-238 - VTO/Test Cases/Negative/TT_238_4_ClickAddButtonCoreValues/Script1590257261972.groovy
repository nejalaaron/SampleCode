...
WebUI.sendKeys(findTestObject('V2/TT-238/VTO_AddCoreValues'), '`~!@#$%^&*()-=_+[]{};:\'",<.>/?|')
...
WebUI.sendKeys(findTestObject('V2/TT-238/VTO_AddCoreValues2'), '`~!@#$%^&*()-=_+[]{};:\'",<.>/?|')
...
WebUI.sendKeys(findTestObject('V2/TT-238/VTO_AddCoreValues3'), '`~!@#$%^&*()-=_+[]{};:\'",<.>/?|')

WebUI.click(findTestObject('V2/TT-238/VTO_ButtonCoreValues'))

WebUI.click(findTestObject('V2/TT-238/VTO_AddCoreValues4'))

WebUI.sendKeys(findTestObject('V2/TT-238/VTO_AddCoreValues4'), Keys.chord(Keys.LEFT_CONTROL, 'a', Keys.BACK_SPACE))

WebUI.sendKeys(findTestObject('V2/TT-238/VTO_AddCoreValues4'), '`~!@#$%^&*()-=_+[]{};:\'",<.>/?|')

WebUI.mouseOver(findTestObject('V2/TT-238/VTO_DeleteCoreValues'))

WebUI.click(findTestObject('V2/TT-238/VTO_DeleteCoreValues'))
