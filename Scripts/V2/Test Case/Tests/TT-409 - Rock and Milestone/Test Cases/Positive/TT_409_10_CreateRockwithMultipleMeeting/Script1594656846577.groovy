...
/*
 Create New Rock with multiple Assign Team Meetings and Milestones in the Dashboard Field
 */
...
TestObject meeting_Name2ValObj = CustomKeywords.'tt_CustomKeywords.CustomKeywords.CreateDynamicElement'(assignedMeeting2_Obj, 
    meetingName2, 'xpath')

WebUI.click(meeting_Name2ValObj)
