...
/*
Create New Rock(DepartmentLevel) and Milestones in the Dashboard Field */
...
WebUI.click(findTestObject('V2/TT-409/Page_Dashboard/Visibility_level_Department(Added to VTO)'))
