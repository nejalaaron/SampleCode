...
WebUI.click(rock_recordObj)

WebUI.delay(20)

/* Edit Rock and Milestone */
WebUI.click(findTestObject('V2/TT-409/Edit_Rock/Edit_Rock_Title'))

WebUI.clearText(findTestObject('V2/TT-409/Edit_Rock/Edit_Rock_Title'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('V2/TT-409/Edit_Rock/Edit_Rock_Title_Name'), editRockName)

WebUI.click(findTestObject('V2/TT-409/Edit_Rock/Edit_Status_Done_Rock'))

WebUI.click(findTestObject('V2/TT-409/Edit_Rock/Edit_Visibility_Level_Field'))

WebUI.click(findTestObject('V2/TT-409/Edit_Rock/Edit_Visibility_Level_Department_Field'))

WebUI.click(findTestObject('V2/TT-409/Edit_Rock/Update_Rock_Button'))

WebUI.delay(5)

TestObject edit_RockRecordObj = CustomKeywords.'tt_CustomKeywords.CustomKeywords.CreateDynamicElement'(verifyRock_Obj, editRockName, 
    'xpath')
