...
WebUI.verifyElementText(findTestObject('V2/TT-413/Page_Meeting Settings/WeekStart'), 'Monday')

WebUI.verifyElementText(findTestObject('V2/TT-413/Page_Meeting Settings/ScorecardColumnHighlight'), 'Previous Week')
