...
WebUI.verifyElementText(findTestObject('V2/TT-413/Page_Leadership L10 - Run Meeting/ToDoAgendaCompletion'), '0% completed')
...
WebUI.verifyElementText(findTestObject('V2/TT-413/Page_Leadership L10 - Run Meeting/ToDoAgendaCompletion'), '67% completed')

WebUI.click(findTestObject('V2/TT-413/Page_Leadership L10 - Run Meeting/ToDo4Checkbox'))
