...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-472 - Meeting Printouts/Test Cases/Positive/Admin/TT_472_1_GenerateMeetingPrintouts_SamePageMeeting_Admin'), 
...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-472 - Meeting Printouts/Test Cases/Positive/Supervisor/TT_472_1_GenerateMeetingPrintouts_SamePageMeeting_Supervisor'), 
    [('meetingName') : meetingName, ('meetingAcronym') : meetingAcronym, ('meetingType') : meetingType, ('dayOfmeeting') : dayOfmeeting
        , ('meetingTime') : meetingTime, ('meetingOptions_obj') : '//h4[text()=\'%s\']/ancestor::div[contains(@class,\'ListContainer\')]/div[@class=\'listcontainer__options\']/button'], 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/TT-472 - Meeting Printouts/Test Cases/Positive/Employee/TT_472_1_GenerateMeetingPrintouts_SamePageMeeting_Employee'), 
    [('meetingName') : meetingName, ('meetingAcronym') : meetingAcronym, ('meetingType') : meetingType, ('dayOfmeeting') : dayOfmeeting
        , ('meetingTime') : meetingTime, ('meetingOptions_obj') : '//h4[text()=\'%s\']/ancestor::div[contains(@class,\'ListContainer\')]/div[@class=\'listcontainer__options\']/button'], 
    FailureHandling.STOP_ON_FAILURE)
