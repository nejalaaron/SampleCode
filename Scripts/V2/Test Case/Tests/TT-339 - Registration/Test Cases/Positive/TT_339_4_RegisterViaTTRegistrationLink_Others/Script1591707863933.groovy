...
WebUI.waitForElementVisible(findTestObject('V2/TT-339/Page_Register/div_implementer_label_others'), 10)

WebUI.focus(findTestObject('V2/TT-339/Page_Register/input_implementer_other'))

WebUI.setText(findTestObject('V2/TT-339/Page_Register/input_implementer_other'), othersVal)
