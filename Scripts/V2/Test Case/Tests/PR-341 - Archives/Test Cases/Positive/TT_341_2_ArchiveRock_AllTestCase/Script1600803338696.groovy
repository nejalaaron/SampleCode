...
WebUI.navigateToUrl(GlobalVariable.V2Url, FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('V2/Test Case/Pre-conditions/PRE_AddMilestone_Rocks'), [:], FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('V2/Test Case/Pre-conditions/PRE_AddAllAttendeesToMeeting'), [('meetingName') : meetingName
        ...
        , ('permission') : permissionDropOptObj_FE], FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('V2/Test Case/Pre-conditions/PRE_AddAllAttendeesToMeeting'), [('meetingName') : meetingName
        ...
        , ('permissionDropOptObj_BE') : '//div[@role=\'alert\' and text()=\'%s\']/ancestor::div[@class=\'editAttendees__item\']//span[text()=\'Basic editor\']/parent::div'
        , ('meetingOptions_obj') : '//h4[text()=\'%s\']/ancestor::div[contains(@class,\'ListContainer\')]/div[@class=\'listcontainer__options\']/button'
        , ('permission') : permissionDropOptObj_BE], FailureHandling.CONTINUE_ON_FAILURE)

WebUI.callTestCase(findTestCase('V2/Test Case/Tests/PR-341 - Archives/Test Cases/Positive/Admin/PR_341_2_ArchiveRock_Admin'), 
    [('userName') : 'jeff+075@mytractiontools.com', ('passWord') : 'Skyline69A*', ('meetingRowPosition') : '3', ('editMeetingMenu_Obj') : '//div[@id=\'root\']/div/div[2]/div/div/div/div[2]/div/div[%s]/div[3]/button/i'
        ...
        , ('meetingName') : meetingName], FailureHandling.CONTINUE_ON_FAILURE)

DriverFactory.changeWebDriver(driver2)

WebUI.callTestCase(findTestCase('V2/Test Case/Tests/PR-341 - Archives/Test Cases/Positive/Supervisor/PR_341_2_ArchiveRock_Supervisor'), 
    [('userName') : 'jeff+075@mytractiontools.com', ('passWord') : 'Skyline69A*', ('meetingRowPosition') : '3', ('editMeetingMenu_Obj') : '//div[@id=\'root\']/div/div[2]/div/div/div/div[2]/div/div[%s]/div[3]/button/i'
        , ('rockName') : 'QA Edit Meeting Automation Rock Test', ('dueDateDay') : '30', ('milestoneName') : 'Milestone 1'
...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/PR-341 - Archives/Test Cases/Positive/Employee/PR_341_2_ArchiveRock_Employee'), 
    [('userName') : 'jeff+075@mytractiontools.com', ('passWord') : 'Skyline69A*', ('meetingRowPosition') : '3', ('editMeetingMenu_Obj') : '//div[@id=\'root\']/div/div[2]/div/div/div/div[2]/div/div[%s]/div[3]/button/i'
        , ('rockName') : 'QA Edit Meeting Automation Rock Test', ('dueDateDay') : '30', ('milestoneName') : 'Milestone 1'
...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/PR-341 - Archives/Test Cases/Positive/Admin/PR_341_2-1_ArchiveRock_Admin'), 
    [('userName') : 'jeff+075@mytractiontools.com', ('passWord') : 'Skyline69A*', ('meetingRowPosition') : '3', ('editMeetingMenu_Obj') : '//div[@id=\'root\']/div/div[2]/div/div/div/div[2]/div/div[%s]/div[3]/button/i'
        , ('rockName') : 'QA Edit Meeting Automation Rock Test', ('dueDateDay') : '30', ('milestoneName') : 'Milestone 1'
        , ('milestoneDate') : '30', ('ownerSelected') : 'Admin User', ('owner_Obj') : '//div[@data-test-id=\'createRock\']//div[@role=\'listbox\'][@class=\'visible menu transition\']/div[@role=\'option\'][contains(@class,\'item\')]/span[text()=\'%s\']'
        , ('verifyRocks_Obj') : '//h2[text()=\'Rocks\']/ancestor::div[contains(@class,\'CardStyles\')]/div[2]//div[@data-test-id=\'rock.title\'][contains(@class,\'TextBodyStyles-sc\') and text()=\'%s\']'
...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/PR-341 - Archives/Test Cases/Positive/Supervisor/PR_341_2-1_ArchiveRock_Supervisor'), 
    [('userName') : 'jeff+075@mytractiontools.com', ('passWord') : 'Skyline69A*', ('meetingRowPosition') : '3', ('editMeetingMenu_Obj') : '//div[@id=\'root\']/div/div[2]/div/div/div/div[2]/div/div[%s]/div[3]/button/i'
        , ('rockName') : 'QA Edit Meeting Automation Rock Test', ('dueDateDay') : '30', ('milestoneName') : 'Milestone 1'
        , ('milestoneDate') : '30', ('ownerSelected') : 'Admin User', ('owner_Obj') : '//div[@data-test-id=\'createRock\']//div[@role=\'listbox\'][@class=\'visible menu transition\']/div[@role=\'option\'][contains(@class,\'item\')]/span[text()=\'%s\']'
        , ('verifyRocks_Obj') : '//h2[text()=\'Rocks\']/ancestor::div[contains(@class,\'CardStyles\')]/div[2]//div[@data-test-id=\'rock.title\'][contains(@class,\'TextBodyStyles-sc\') and text()=\'%s\']'
...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/PR-341 - Archives/Test Cases/Positive/Employee/PR_341_2-1_ArchiveRock_Employee'), 
    [('userName') : 'jeff+075@mytractiontools.com', ('passWord') : 'Skyline69A*', ('meetingRowPosition') : '3', ('editMeetingMenu_Obj') : '//div[@id=\'root\']/div/div[2]/div/div/div/div[2]/div/div[%s]/div[3]/button/i'
        , ('rockName') : 'QA Edit Meeting Automation Rock Test', ('dueDateDay') : '30', ('milestoneName') : 'Milestone 1'
        , ('milestoneDate') : '30', ('ownerSelected') : 'Admin User', ('owner_Obj') : '//div[@data-test-id=\'createRock\']//div[@role=\'listbox\'][@class=\'visible menu transition\']/div[@role=\'option\'][contains(@class,\'item\')]/span[text()=\'%s\']'
        , ('verifyRocks_Obj') : '//h2[text()=\'Rocks\']/ancestor::div[contains(@class,\'CardStyles\')]/div[2]//div[@data-test-id=\'rock.title\'][contains(@class,\'TextBodyStyles-sc\') and text()=\'%s\']'
