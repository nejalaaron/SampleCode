...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/PR-341 - Archives/Test Cases/Positive/Admin/PR_341_4_ArchiveToDo_Admin'), 
    [('userName') : 'jeff+075@mytractiontools.com', ('passWord') : 'Skyline69A*', ('meetingRowPosition') : '3', ('editMeetingMenu_Obj') : '//div[@id=\'root\']/div/div[2]/div/div/div/div[2]/div/div[%s]/div[3]/button/i'
        , ('toDoName') : 'QA Edit Meeting Automation ToDo Test', ('accountableOwner') : 'Admin User', ('accountableOwner_Obj') : '//div[@data-test-id=\'createTodo\']//div[@role=\'listbox\'][@class=\'visible menu transition\']/div[@role=\'option\'][contains(@class,\'item\')]/span[text()=\'%s\']'
        , ('dueDate') : '30', ('dueDate_Obj') : '(//*[normalize-space(text()) and normalize-space(.)=\'July 2020\'])[1]/following::div[%s]'
        , ('Notes') : 'Sample Notes', ('verifyToDo_Obj') : '//h2[text()=\'To-Dos\']/ancestor::div[contains(@class,\'CardStyles\')]//button/div[text()=\'%s\']'
        , ('editToDoName') : 'Updated QA Edit Meeting Automation ToDo Test', ('editAccountableOwner') : 'Admin User', ('editDueDate') : '10'
        , ('editaccountableOwner_Obj') : '//div[@data-test-id=\'editTodo\']//div[@role=\'listbox\'][@class=\'visible menu transition\']/div[@role=\'option\'][contains(@class,\'item\')]/span[text()=\'%s\']'
        , ('meetingOptions_obj') : '//h4[text()=\'%s\']/ancestor::div[contains(@class,\'ListContainer\')]/div[@class=\'listcontainer__options\']/button'
        , ('meetingName') : meetingName, ('toDoText_Obj') : '(//div[@data-test-id=\'todo.title\']/child::input[@aria-label=\'To-Do Title\'])[2]'], 
    FailureHandling.STOP_ON_FAILURE)

DriverFactory.changeWebDriver(driver2)

WebUI.callTestCase(findTestCase('V2/Test Case/Tests/PR-341 - Archives/Test Cases/Positive/Supervisor/PR_341_4_ArchiveToDo_Supervisor'), 
    [('userName') : 'jeff+075@mytractiontools.com', ('passWord') : 'Skyline69A*', ('meetingRowPosition') : '3', ('editMeetingMenu_Obj') : '//div[@id=\'root\']/div/div[2]/div/div/div/div[2]/div/div[%s]/div[3]/button/i'
        , ('toDoName') : 'QA Edit Meeting Automation ToDo Test', ('accountableOwner') : 'Supervisor User', ('accountableOwner_Obj') : '//div[@data-test-id=\'createTodo\']//div[@role=\'listbox\'][@class=\'visible menu transition\']/div[@role=\'option\'][contains(@class,\'item\')]/span[text()=\'%s\']'
        , ('dueDate') : '30', ('dueDate_Obj') : '(//*[normalize-space(text()) and normalize-space(.)=\'July 2020\'])[1]/following::div[%s]'
        , ('Notes') : 'Sample Notes', ('verifyToDo_Obj') : '//h2[text()=\'To-Dos\']/ancestor::div[contains(@class,\'CardStyles\')]//button/div[text()=\'%s\']'
        , ('editToDoName') : 'Updated QA Edit Meeting Automation ToDo Test', ('editAccountableOwner') : 'Supervisor User'
        , ('editDueDate') : '10', ('editaccountableOwner_Obj') : '//div[@data-test-id=\'editTodo\']//div[@role=\'listbox\'][@class=\'visible menu transition\']/div[@role=\'option\'][contains(@class,\'item\')]/span[text()=\'%s\']'
        , ('meetingOptions_obj') : '//h4[text()=\'%s\']/ancestor::div[contains(@class,\'ListContainer\')]/div[@class=\'listcontainer__options\']/button'
        , ('meetingName') : meetingName, ('toDoText_Obj') : '(//div[@data-test-id=\'todo.title\']/child::input[@aria-label=\'To-Do Title\'])[2]'], 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/PR-341 - Archives/Test Cases/Positive/Employee/PR_341_4_ArchiveToDo_Employee'), 
    [('userName') : 'jeff+075@mytractiontools.com', ('passWord') : 'Skyline69A*', ('meetingRowPosition') : '3', ('editMeetingMenu_Obj') : '//div[@id=\'root\']/div/div[2]/div/div/div/div[2]/div/div[%s]/div[3]/button/i'
        , ('toDoName') : 'QA Edit Meeting Automation ToDo Test', ('accountableOwner') : 'Employee User', ('accountableOwner_Obj') : '//div[@data-test-id=\'createTodo\']//div[@role=\'listbox\'][@class=\'visible menu transition\']/div[@role=\'option\'][contains(@class,\'item\')]/span[text()=\'%s\']'
        , ('dueDate') : '30', ('dueDate_Obj') : '(//*[normalize-space(text()) and normalize-space(.)=\'July 2020\'])[1]/following::div[%s]'
        , ('Notes') : 'Sample Notes', ('verifyToDo_Obj') : '//h2[text()=\'To-Dos\']/ancestor::div[contains(@class,\'CardStyles\')]//button/div[text()=\'%s\']'
        , ('editToDoName') : 'Updated QA Edit Meeting Automation ToDo Test', ('editAccountableOwner') : 'Employee User', ('editDueDate') : '10'
        , ('editaccountableOwner_Obj') : '//div[@data-test-id=\'editTodo\']//div[@role=\'listbox\'][@class=\'visible menu transition\']/div[@role=\'option\'][contains(@class,\'item\')]/span[text()=\'%s\']'
        , ('meetingOptions_obj') : '//h4[text()=\'%s\']/ancestor::div[contains(@class,\'ListContainer\')]/div[@class=\'listcontainer__options\']/button'
        , ('meetingName') : meetingName, ('toDoText_Obj') : '(//div[@data-test-id=\'todo.title\']/child::input[@aria-label=\'To-Do Title\'])[2]'], 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/PR-341 - Archives/Test Cases/Positive/Admin/PR_341_4-1_ArchiveTodo_Admin'), 
    [('meetingName') : meetingName, ('meetingRecord_obj') : '//div[@class=\'detailscontainer__block item\']/h4[text()=\'%s\']'
        , ('meetingGoToMeeting_Obj') : '//div[@class=\'detailscontainer__block item\']/h4[text()=\'%s\']/ancestor::div[contains(@class,\'ListContainer\')]//div[@class=\'item\']//button[.=\'Go to meeting\']'
        , ('meetingOptions_obj') : '//h4[text()=\'%s\']/ancestor::div[contains(@class,\'ListContainer\')]/div[@class=\'listcontainer__options\']/button'], 
    FailureHandling.STOP_ON_FAILURE)

DriverFactory.changeWebDriver(driver2)

WebUI.callTestCase(findTestCase('V2/Test Case/Tests/PR-341 - Archives/Test Cases/Positive/Supervisor/PR_341_4-1_ArchiveTodo_Supervisor'), 
    [('meetingName') : meetingName, ('meetingRecord_obj') : '//div[@class=\'detailscontainer__block item\']/h4[text()=\'%s\']'
        , ('meetingGoToMeeting_Obj') : '//div[@class=\'detailscontainer__block item\']/h4[text()=\'%s\']/ancestor::div[contains(@class,\'ListContainer\')]//div[@class=\'item\']//button[.=\'Go to meeting\']'
        , ('meetingOptions_obj') : '//h4[text()=\'%s\']/ancestor::div[contains(@class,\'ListContainer\')]/div[@class=\'listcontainer__options\']/button'], 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/PR-341 - Archives/Test Cases/Positive/Employee/PR_341_4-1_ArchiveTodo_Employee'), 
    [('meetingName') : meetingName, ('meetingRecord_obj') : '//div[@class=\'detailscontainer__block item\']/h4[text()=\'%s\']'
        , ('meetingGoToMeeting_Obj') : '//div[@class=\'detailscontainer__block item\']/h4[text()=\'%s\']/ancestor::div[contains(@class,\'ListContainer\')]//div[@class=\'item\']//button[.=\'Go to meeting\']'
        , ('meetingOptions_obj') : '//h4[text()=\'%s\']/ancestor::div[contains(@class,\'ListContainer\')]/div[@class=\'listcontainer__options\']/button'], 
    FailureHandling.STOP_ON_FAILURE)
