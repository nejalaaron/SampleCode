...
WebUI.waitForElementVisible(findTestObject('V2/PR-341/Page_Archives/Verify_Employee_User_Scorecard'), GlobalVariable.DefaultTimeout)

WebUI.verifyElementPresent(findTestObject('V2/PR-341/Page_Archives/Verify_Employee_User_Scorecard'), GlobalVariable.DefaultTimeout)
