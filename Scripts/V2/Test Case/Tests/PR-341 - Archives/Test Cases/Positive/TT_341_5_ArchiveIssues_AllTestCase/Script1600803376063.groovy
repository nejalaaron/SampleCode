...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/PR-341 - Archives/Test Cases/Positive/Admin/PR_341_5_ArchiveIssues_Admin'), 
    [('userName') : 'jeff+075@mytractiontools.com', ('passWord') : 'Skyline69A*', ('meetingRowPosition') : '3', ('editMeetingMenu_Obj') : '//div[@id=\'root\']/div/div[2]/div/div/div/div[2]/div/div[%s]/div[3]/button/i'
        , ('issuesName') : 'QA Automation Edit Meeting Issue Test', ('owner') : 'Admin User', ('owner_Obj') : '//div[@data-test-id=\'createIssue\']//div[@role=\'listbox\'][@class=\'visible menu transition\']/div[@role=\'option\'][contains(@class,\'item\')]/span[text()=\'%s\']'
        , ('Notes') : 'Sample Notes', ('verifyIssues_Obj') : '//h2[text()=\'Issues\']/ancestor::div[contains(@class,\'CardStyles\')]//button/div[text()=\'%s\']'
        , ('editIssuesName') : 'Updated QA Automation Edit Meeting Issue Test', ('editOwner_Obj') : '//div[@data-test-id=\'editIssue\']//div[@role=\'listbox\'][@class=\'visible menu transition\']/div[@role=\'option\'][contains(@class,\'item\')]/span[text()=\'%s\']'
        , ('editOwner') : 'Admin User', ('meetingOptions_obj') : '//h4[text()=\'%s\']/ancestor::div[contains(@class,\'ListContainer\')]/div[@class=\'listcontainer__options\']/button'
        , ('meetingName') : meetingName], FailureHandling.STOP_ON_FAILURE)

DriverFactory.changeWebDriver(driver2)

WebUI.callTestCase(findTestCase('V2/Test Case/Tests/PR-341 - Archives/Test Cases/Positive/Supervisor/PR_341_5_ArchiveIssues_Supervisor'), 
    [('userName') : 'jeff+075@mytractiontools.com', ('passWord') : 'Skyline69A*', ('meetingRowPosition') : '3', ('editMeetingMenu_Obj') : '//div[@id=\'root\']/div/div[2]/div/div/div/div[2]/div/div[%s]/div[3]/button/i'
        , ('issuesName') : 'QA Automation Edit Meeting Issue Test', ('owner') : 'Supervisor User', ('owner_Obj') : '//div[@data-test-id=\'createIssue\']//div[@role=\'listbox\'][@class=\'visible menu transition\']/div[@role=\'option\'][contains(@class,\'item\')]/span[text()=\'%s\']'
        , ('Notes') : 'Sample Notes', ('verifyIssues_Obj') : '//h2[text()=\'Issues\']/ancestor::div[contains(@class,\'CardStyles\')]//button/div[text()=\'%s\']'
        , ('editIssuesName') : 'Updated QA Automation Edit Meeting Issue Test', ('editOwner_Obj') : '//div[@data-test-id=\'editIssue\']//div[@role=\'listbox\'][@class=\'visible menu transition\']/div[@role=\'option\'][contains(@class,\'item\')]/span[text()=\'%s\']'
        , ('editOwner') : 'Supervisor User', ('meetingOptions_obj') : '//h4[text()=\'%s\']/ancestor::div[contains(@class,\'ListContainer\')]/div[@class=\'listcontainer__options\']/button'
        , ('meetingName') : meetingName], FailureHandling.STOP_ON_FAILURE)

DriverFactory.changeWebDriver(driver3)

WebUI.callTestCase(findTestCase('V2/Test Case/Tests/PR-341 - Archives/Test Cases/Positive/Employee/PR_341_5_ArchiveIssues_Employee'), 
    [('userName') : 'jeff+075@mytractiontools.com', ('passWord') : 'Skyline69A*', ('meetingRowPosition') : '3', ('editMeetingMenu_Obj') : '//div[@id=\'root\']/div/div[2]/div/div/div/div[2]/div/div[%s]/div[3]/button/i'
        , ('issuesName') : 'QA Automation Edit Meeting Issue Test', ('owner') : 'Employee User', ('owner_Obj') : '//div[@data-test-id=\'createIssue\']//div[@role=\'listbox\'][@class=\'visible menu transition\']/div[@role=\'option\'][contains(@class,\'item\')]/span[text()=\'%s\']'
        , ('Notes') : 'Sample Notes', ('verifyIssues_Obj') : '//h2[text()=\'Issues\']/ancestor::div[contains(@class,\'CardStyles\')]//button/div[text()=\'%s\']'
        , ('editIssuesName') : 'Updated QA Automation Edit Meeting Issue Test', ('editOwner_Obj') : '//div[@data-test-id=\'editIssue\']//div[@role=\'listbox\'][@class=\'visible menu transition\']/div[@role=\'option\'][contains(@class,\'item\')]/span[text()=\'%s\']'
        , ('editOwner') : 'Employee User', ('meetingOptions_obj') : '//h4[text()=\'%s\']/ancestor::div[contains(@class,\'ListContainer\')]/div[@class=\'listcontainer__options\']/button'
        , ('meetingName') : meetingName], FailureHandling.STOP_ON_FAILURE)

DriverFactory.changeWebDriver(driver1)

WebUI.callTestCase(findTestCase('V2/Test Case/Tests/PR-341 - Archives/Test Cases/Positive/Admin/PR_341_5-1_ArchiveIssues_Admin'), 
    [('userName') : 'jeff+075@mytractiontools.com', ('passWord') : 'Skyline69A*', ('meetingRowPosition') : '3', ('editMeetingMenu_Obj') : '//div[@id=\'root\']/div/div[2]/div/div/div/div[2]/div/div[%s]/div[3]/button/i'
        , ('issuesName') : 'QA Automation Edit Meeting Issue Test', ('owner') : 'Admin User', ('owner_Obj') : '//div[@data-test-id=\'createIssue\']//div[@role=\'listbox\'][@class=\'visible menu transition\']/div[@role=\'option\'][contains(@class,\'item\')]/span[text()=\'%s\']'
        , ('Notes') : 'Sample Notes', ('verifyIssues_Obj') : '//h2[text()=\'Issues\']/ancestor::div[contains(@class,\'CardStyles\')]//button/div[text()=\'%s\']'
        , ('editIssuesName') : 'Updated QA Automation Edit Meeting Issue Test', ('editOwner_Obj') : '//div[@data-test-id=\'editIssue\']//div[@role=\'listbox\'][@class=\'visible menu transition\']/div[@role=\'option\'][contains(@class,\'item\')]/span[text()=\'%s\']'
...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/PR-341 - Archives/Test Cases/Positive/Supervisor/PR_341_5-1_ArchiveIssues_Supervisor'), 
    [('userName') : 'jeff+075@mytractiontools.com', ('passWord') : 'Skyline69A*', ('meetingRowPosition') : '3', ('editMeetingMenu_Obj') : '//div[@id=\'root\']/div/div[2]/div/div/div/div[2]/div/div[%s]/div[3]/button/i'
        , ('issuesName') : 'QA Automation Edit Meeting Issue Test', ('owner') : 'Supervisor User', ('owner_Obj') : '//div[@data-test-id=\'createIssue\']//div[@role=\'listbox\'][@class=\'visible menu transition\']/div[@role=\'option\'][contains(@class,\'item\')]/span[text()=\'%s\']'
        , ('Notes') : 'Sample Notes', ('verifyIssues_Obj') : '//h2[text()=\'Issues\']/ancestor::div[contains(@class,\'CardStyles\')]//button/div[text()=\'%s\']'
        , ('editIssuesName') : 'Updated QA Automation Edit Meeting Issue Test', ('editOwner_Obj') : '//div[@data-test-id=\'editIssue\']//div[@role=\'listbox\'][@class=\'visible menu transition\']/div[@role=\'option\'][contains(@class,\'item\')]/span[text()=\'%s\']'
...
WebUI.callTestCase(findTestCase('V2/Test Case/Tests/PR-341 - Archives/Test Cases/Positive/Employee/PR_341_5-1_ArchiveIssues_Employee'), 
    [('userName') : 'jeff+075@mytractiontools.com', ('passWord') : 'Skyline69A*', ('meetingRowPosition') : '3', ('editMeetingMenu_Obj') : '//div[@id=\'root\']/div/div[2]/div/div/div/div[2]/div/div[%s]/div[3]/button/i'
        , ('issuesName') : 'QA Automation Edit Meeting Issue Test', ('owner') : 'Employee User', ('owner_Obj') : '//div[@data-test-id=\'createIssue\']//div[@role=\'listbox\'][@class=\'visible menu transition\']/div[@role=\'option\'][contains(@class,\'item\')]/span[text()=\'%s\']'
        , ('Notes') : 'Sample Notes', ('verifyIssues_Obj') : '//h2[text()=\'Issues\']/ancestor::div[contains(@class,\'CardStyles\')]//button/div[text()=\'%s\']'
        , ('editIssuesName') : 'Updated QA Automation Edit Meeting Issue Test', ('editOwner_Obj') : '//div[@data-test-id=\'editIssue\']//div[@role=\'listbox\'][@class=\'visible menu transition\']/div[@role=\'option\'][contains(@class,\'item\')]/span[text()=\'%s\']'
