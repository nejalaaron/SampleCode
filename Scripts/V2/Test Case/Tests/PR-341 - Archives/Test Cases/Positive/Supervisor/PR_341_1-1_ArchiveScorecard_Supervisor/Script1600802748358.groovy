...
WebUI.waitForElementVisible(findTestObject('V2/PR-341/Page_Archives/Verify_Supervisor_User_Scorecard'), GlobalVariable.DefaultTimeout)

WebUI.verifyElementPresent(findTestObject('V2/PR-341/Page_Archives/Verify_Supervisor_User_Scorecard'), GlobalVariable.DefaultTimeout)
