...
WebUI.waitForElementPresent(findTestObject('V2/TT-712/Page_Edit Meeting/NameDropdown'), GlobalVariable.DefaultTimeout)
...
WebUI.click(findTestObject('V2/TT-712/Page_Edit Meeting/PermissionDropdown2'))

WebUI.click(findTestObject('V2/TT-712/Page_Edit Meeting/PermissionDropdown2AdminOption'))

WebUI.delay(5)

WebUI.verifyElementClickable(findTestObject('V2/TT-712/Page_Edit Meeting/NameDropdown'))

WebUI.verifyElementClickable(findTestObject('V2/TT-712/Page_Edit Meeting/PermissionDropdown'))

WebUI.verifyElementAttributeValue(findTestObject('V2/TT-712/Page_Edit Meeting/DeleteUserButton'), 'class', 'BtnIconStyles-k8ghfj-0 fkFgWq', 
    0)
