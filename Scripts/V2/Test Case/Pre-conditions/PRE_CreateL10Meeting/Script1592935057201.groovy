...
WebUI.click(findTestObject('Object Repository/V2/Commons/MeetingListPage/button_Level 10'))
...
WebUI.click(findTestObject('V2/Commons/CreateL10MeetingDrawer/div_Create Meeting'))

WebUI.waitForElementVisible(findTestObject('Object Repository/V2/Commons/MeetingListPage/div_Ill do this later'), GlobalVariable.DefaultTimeout)
