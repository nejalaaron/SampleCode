...
WebUI.callTestCase(findTestCase('V2/Test Case/Pre-conditions/PRE_AddAllAttendeesToMeeting'), [('meetingName') : '', ('firstname') : ''
        , ('lastname') : '', ('userOptionObj') : '(//span[text()=\'%s\']/parent::div[@role=\'option\'])[2]', ('permissionDropObj') : '//div[@role=\'alert\' and text()=\'%s\']/ancestor::div[@class=\'editAttendees__item\']//button[contains(@aria-label,\'assign\')]/parent::div'
        ...
        , ('permission') : ''], FailureHandling.STOP_ON_FAILURE)
